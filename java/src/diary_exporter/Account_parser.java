...
public class Account_parser {
    public static Account getAccount(Html_getter h, String login) throws IOException, MalformedURLException, InterruptedException {
        ...
        Diary_exporter.logger.info("comment_list_step");   
        comment_list_step(h, acc);
        Diary_exporter.logger.info("white_black_list_step");   
        white_black_list_step(h, acc);
        Diary_exporter.logger.info("member_step");   
        member_step(h, acc);
        Diary_exporter.logger.info("tags_step");   
        tags_step(h, acc);
        Diary_exporter.logger.info("profile_step");   
        profile_step(h, acc);
        Diary_exporter.logger.info("geography_step");   
        geography_step(h, acc);
        Diary_exporter.logger.info("epigraph_step");   
        epigraph_step(h, acc);  
        Diary_exporter.logger.info("Account_parser stop");     
    ...
    private static void first_step(Html_getter h, Account acc) throws IOException, MalformedURLException, InterruptedException {
        ...
        Diary_exporter.logger.info("find diary " + journal);
        switch(journal){
            case "Мой дневник":
                acc.journal = "1";
    ...
    private static void journal_list_step(Html_getter h, Account acc) throws IOException, MalformedURLException, InterruptedException {
    ...
    private static void comment_list_step(Html_getter h, Account acc) throws IOException, MalformedURLException, InterruptedException {
    ...
    private static void white_black_list_step(Html_getter h, Account acc) throws IOException, MalformedURLException, InterruptedException {
        Document doc = Jsoup.parse(h.get("http://www.diary.ru/options/member/?access"));
    ...
    private static void tags_step(Html_getter h, Account acc) throws IOException, MalformedURLException, InterruptedException {
    ...
    private static void profile_step(Html_getter h, Account acc) throws IOException, MalformedURLException, InterruptedException {
    ...
    private static void geography_step(Html_getter h, Account acc) throws IOException, MalformedURLException, InterruptedException {
        ...
        for(Element el: timezone) {
            if(el.hasAttr("selected")) {
                acc.timezone = el.attr("value").toString();
            }
        }
    }
    private static void epigraph_step(Html_getter h, Account acc) throws IOException, MalformedURLException, InterruptedException {
